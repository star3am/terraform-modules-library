...
| <a name="module_transition_bucket"></a> [transition\_bucket](#module\_transition\_bucket) | github.com/star3am/terraform-modules-library//aws/modules/terraform-aws-s3-bucket | main |
