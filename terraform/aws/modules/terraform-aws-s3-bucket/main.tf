...
resource "aws_s3_bucket_lifecycle_configuration" "this" {
  ...
  #checkov:skip=CKV_AWS_300:abort_incomplete_multipart_upload is configured
...
resource "aws_s3_bucket_public_access_block" "this" {
  ...
  #checkov:skip=CKV_AWS_53:block_public_acls is enabled
  #checkov:skip=CKV_AWS_54:block_public_policy is enabled
  #checkov:skip=CKV_AWS_55:ignore_public_acls is enabled
  #checkov:skip=CKV_AWS_56:restrict_public_bucket is enabled
