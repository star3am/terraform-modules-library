...
locals {
  bucket_name      = "standard-bucket-${random_string.my_random.id}"
  logs_bucket_name = "standard-bucket-logs-${random_string.my_random.id}"
}
...
#data "aws_iam_policy_document" "standard_bucket_policy" {
#}
...
module "standard_bucket" {
  ...
  #attach_policy                            = true
  #policy                                   = data.aws_iam_policy_document.standard_bucket_policy.json
  attach_deny_insecure_transport_policy    = true
  attach_require_latest_tls_policy         = true
